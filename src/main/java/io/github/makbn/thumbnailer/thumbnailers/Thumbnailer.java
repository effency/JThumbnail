...
public interface Thumbnailer extends Closeable {
   ...
   */
  void generateThumbnail(File input, File output, String mimeType, ResizeParameters params)
   ...
   *           If the thumbnailing process failed.
   */
  void generateThumbnail(File input, File output, ResizeParameters params) throws IOException, ThumbnailerException;
   ...
   */
  void setImageSize(int imageResizeOptions);
